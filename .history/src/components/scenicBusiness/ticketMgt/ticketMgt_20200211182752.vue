 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-11 18:27:52
 -->
<template>
    <div class="app-container">
        ...
        <el-dialog
            ...
            <el-form 
                ...
                size="small" 
                label-width="120px">
                <el-form-item label="房间类型：" prop="ticketName" >
                ...
                <el-form-item label="房间数量：" prop="ticketNumber">
...
import { queryMyScenic, queryTicket } from '@/api/scenicBusiness'

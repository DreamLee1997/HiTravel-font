 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-04-12 15:47:22
 -->
<template>
    <div class="app-container">
        ...
        <el-card class="content-container" v-loading="listloading">
            ...
            <div class="table-container" v-if="!isShowScenic" >
                ...
                <el-table       
                    ...
                    v-loading="isloading"
                    style="width: 100%">
                    <el-table-column label="景区编号" align="center" prop="scenicId" >
                    </el-table-column>
                    <el-table-column label="门票编号" prop="ticketId"  align="center">
                    </el-table-column>
                        <el-table-column label="门票种类" prop="ticketName" :show-overflow-tooltip='istooltip'  align="center">
                    </el-table-column>
                    <el-table-column label="门票数量" prop="ticketNumber" align="center">
                    </el-table-column>
                    <el-table-column label="原价" prop="normalPrice" align="center">
                    </el-table-column>
                    <el-table-column label="现价" prop="sellPrice" align="center">
                    </el-table-column>
                    <el-table-column label="门票状态" :show-overflow-tooltip='istooltip' align="center">
        ...
        <el-dialog
            ...
            <el-form 
                ...
                <el-form-item label="门票状态：" prop="status">
                    <el-radio-group v-model="updateTicket.status" :disabled="isEdit">
...
import { queryMyScenic, queryTicket, addTicket, updateTicket, searchTicket } from '@/api/scenicBusiness'

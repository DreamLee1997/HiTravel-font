        ...
        <el-dialog
            ...
            <el-form 
                ...
                <el-form-item label="酒店名称：" prop="scenicName">
                    <el-input class="form-input" v-model="editScenic.scenicName" :disabled="isEdit"></el-input>
                </el-form-item>
...
<script>
import {queryMyScenic, searchScenic, updateScenic} from '@/api/scenicBusiness'
...
export default {
    ...
    methods: {
        ...
        handleEditConfirm(){
            let self = this;
            console.log(self.editScenic)
            //获取省label
            let provinceItem = {};
            provinceItem = self.provinceCodeOptions.find((item)=>{//this.ruleForm
                return item.value === self.editScenic.provinceCode;//筛选出匹配数据
            });
            self.editScenic.provinceName = provinceItem.label;
            //获取市label
            let cityItem = {};
            cityItem = self.cityCodeOptions.find((item)=>{//this.ruleForm
                return item.value === self.editScenic.cityCode;//筛选出匹配数据
            });
            self.editScenic.cityName = cityItem.label;

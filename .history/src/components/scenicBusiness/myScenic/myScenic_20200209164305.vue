<template>
    <div class="app-container">
        ...
        <el-card class="register-container">
            <el-form :model="regScenicInfo" :rules="rules" ref="regHotelForm" label-width="150px" class="regHotelForm">
...
<script>
import {registerScence} from '@/api/scenicBusiness'
...
export default {
    ...
    methods: {
        ...
        handleAddScenic(){
            ...
            params.cityCode = self.areaCode[1];

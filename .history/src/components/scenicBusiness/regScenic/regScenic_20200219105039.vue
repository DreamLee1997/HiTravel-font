<template>
  <div class="app-container">
    <el-card class="operate-container">
      ...
      <el-button class="btn-add" type="primary" @click="handleAddScenic" size="mini">提交</el-button>
    </el-card>
    <el-card class="register-container">
      ...
      <div v-else style="text-align: center; margin-top: 85px;">
        <svg-icon icon-class="waitVerify" style="width: 216px; height: 216px;"></svg-icon>
      </div>
    </el-card>
  </div>
</template>

      ...
      <div class="main-in">  
        <div class="main-in-top">
          ...
          <div class="main-in-top-in" >
            ...
            <div class="scenicRmd" v-if="cityInfo.cityName">
              <div >
                      ...
                      <el-col 
                        ...
                        v-for="(scenicInfo, index) in scenicList" :key="index" >
                          <el-card :body-style="{ padding: '0px' }">
                            <img style="width: 230px; height:230px;" :src="'http://101.132.138.185:8080'+scenicInfo.img" class="image">
                          </el-card>
                          <div class="cityName">{{scenicInfo.scenicName}}</div>
                      </el-col>
                  </el-row>
              </div>
            </div>

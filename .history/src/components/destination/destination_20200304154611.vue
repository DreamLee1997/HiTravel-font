      ...
      <div class="main-in">  
        <div class="main-in-top">
          ...
          <div class="main-in-top-in" >
            ...
            <scenic-rmd id="scenicRmd" ref="box" :cityInfo="cityInfo" v-if="cityInfo.cityName"></scenic-rmd>
...
export default {
    ...
    methods: {
        ...
        toDestination(val) {
            ...
            self.isShow = false;
            document.getElementById('scenicRmd').scrollIntoView({ behavior: "smooth" });
            // self.$refs.box.scrollTop = 700;
        },
        //搜索
        handleSearch() {
            let self = this;

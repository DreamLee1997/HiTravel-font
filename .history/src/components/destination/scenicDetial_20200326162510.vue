 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-26 16:25:10
 -->
<template>
    ...
    <div class="main">
      <div class="main-in">
        <div class="main-in-top">
          <div class="content">
            <a class="order" @click="handleBack">{{scenicInfo.scenicName}}景区</a>>
            <a class="order">订门票</a>
          </div>
        </div>
        ...
        <div class="main-in-bottom">
          ...
          <div class="table-container">
            <el-table ref="ticketTable" :data="roomList" style="width: 100%" v-loading="listLoading">
...
export default {
  ...
  methods: {
    ...
    getScenicInfo() {
      ...
      searchScenic(self.scenicId).then(res => {
        ...
        self.mapLocation.address =
          self.scenicInfo.provinceName +
          "省" +
          self.scenicInfo.cityName +
          "市" ;
          var myGeo = new this.BMap.Geocoder();
          myGeo.getPoint(
            self.mapLocation.address,
    ...
    //   }
    //   queryRoomByTime(self.scenicId, self.inDate).then(res => {

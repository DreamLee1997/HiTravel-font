 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-28 10:23:18
 -->
<template>
      ...
      <div class="main-in">
        ...
        <div class="main-in-bottom">
          ...
          <div class="table-container">
            <el-table ref="ticketTable" :data="ticketList" style="width: 100%" v-loading="listLoading">
...
export default {
  ...
  methods: {
    ...
    //   }
      queryTicket(self.scenicId, self.listQuery.pageNo, self.listQuery.pageSize).then(res => {
        self.ticketList = res.data;

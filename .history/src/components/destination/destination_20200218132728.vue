<template>
  ...
  <div class="banner">
        ...
        <div class="search">
            ...
            <div class="go">
                <el-input v-model="destination" placeholder="我想去..." style="width: 250px;"></el-input>
                <!-- <input type="text" value="我想去..." /> -->
                <el-button 
                    icon="el-icon-search" 
                    @click="handleSearch"
                    type="primary" 
            ...
            <div class="main-in-top">
                <div class="main-in-top-in">
                    ...
                    <div class="main-in-er">
                        ...
                        <div class="tjdf-er">
                            <ul>
                                <li class="dangxia-er"><a href="">高铁直达</a></li>
                                <li><a href="">台湾</a></li>
                                <li><a href="">国内其他地区</a></li>
                            </ul>
                        </div>
                        <div class="tjwf-er">
                            <ul>
...
.xt {
    width:34px;
    height:20px;
    background:url(../../assets/img/place-sprites3.png) no-repeat -31px -60px;
    position:absolute;
    left:50%;
    bottom:24px;
}
...
.tjwf-er ul li:nth-of-type(4) .jt {
    margin-top:20px;
    font-size:14px;
    height:20px;
    line-height:20px;
...
.tjwf-er ul li:nth-of-type(5) .jt {
    margin-top:20px;
    font-size:14px;
    height:20px;
    line-height:20px;

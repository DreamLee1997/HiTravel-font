...
export default {
    ...
    methods:{
        ...
        toDestination(val){
            let self = this;
            this.$router.push({ path: "/destination/scenicRmd" , params: { cityCode: self.cityCodeArray[val] }});
        ...
        handleSearch(){
            ...
            self.$router.push({ path: "/destination/scenicRmd" , params: { cityCode: params.cityCode }});
            // fetchList(
            //     params.page,
            //     params.size,
            //     params.cityCode

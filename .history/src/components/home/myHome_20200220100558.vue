<template>
    <div class="app-wapper">
                ...
                <el-menu
                    ...
                    active-text-color="#ffd04b">
                     <el-menu-item index="a" @click="goTo('/writeStrategy')">
                        ...
                        <span slot="title">写攻略</span></el-menu-item>
                     <el-menu-item index="b" @click="goTo('/myHome/myStrategy')">
                        <i class="el-icon-document"></i>
                        <span slot="title">我的攻略</span></el-menu-item>
                    ...
                    <el-menu-item index="e" @click="goTo('/myHome/myFavorites')">
                        ...
                        <span slot="title">修改信息</span></el-menu-item>
        ...
        <div v-if="!writeType" class="main-container"><router-view></router-view></div>
        <div v-if="writeType" class="main-container">
            <!-- <el-row> -->
                <!-- <el-col :span="12" v-for="(o, index) in 2" :key="index" > -->
                    <el-card :body-style="{ padding: '0px',width:'300px' }" v-for="(o, index) in 2" :key="index">

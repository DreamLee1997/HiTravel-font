 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-28 11:47:45
 -->
<template>
    <div class="myStrategy" >
        我的订单
        <el-tabs type="border-card">
            <el-tab-pane label="用户管理">全部订单</el-tab-pane>
            <el-tab-pane label="配置管理">酒店订单</el-tab-pane>
            <el-tab-pane label="角色管理">门票订单</el-tab-pane>
            <el-tab-pane label="定时任务补偿">已预定</el-tab-pane>
            <el-tab-pane label="定时任务补偿">已取消</el-tab-pane>
        </el-tabs>
        <!-- <el-table
            :data="tableData"
            v-loading="isloading"

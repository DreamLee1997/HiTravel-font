 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-20 12:03:57
 -->
<template>
  <div class="myStrategy">
        <el-row>
            <el-col :span="24" v-for="(item, index) in strategyList" :key="index" >
                <el-card :body-style="{ padding: '0px'  , cursor:'pointer' , display: 'flex'}">
                    <img :src="item.imgUrl" class="image" @click.native="handleView(item.articleId)">
                    <div class="content-r" >

 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-24 11:22:43
 -->
<template>
  ...
  methods: {
    ...
    handleOrder(row){
      ...
      if(self.daterange.length){
        console.log(self.daterange[0].getTime(self.daterange[0]))
        this.$set(self.orderInfo, "daterange", [
          // self.daterange[0].getTime(self.daterange[0]),
          // self.daterange[1].getTime(self.daterange[1])
        ]);
        // self.orderInfo.daterange = [
        //   self.daterange[0].getTime(self.daterange[0]),
        //   self.daterange[1].getTime(self.daterange[1])];
      }

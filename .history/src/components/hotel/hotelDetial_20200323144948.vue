 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-23 14:49:48
 -->
<template>
  <div class="hotelDetial">
    ...
    <el-dialog
      ...
      <el-form 
          ...
          size="small" 
          label-width="120px">
          <el-form-item label="房间名称：" prop="realname" >
              <el-input class="form-input" v-model="orderInfo.roomName"></el-input>
          </el-form-item>
          <el-form-item label="房间单价：" prop="phone">
              <el-input class="form-input" v-model="orderInfo.phone"></el-input>
          </el-form-item>
          <el-form-item label="身份证号：" prop="cardId">
              <el-input class="form-input" v-model="orderInfo.cardId"></el-input>
          </el-form-item>
          <el-form-item label="法人邮箱：" prop="email">
              <el-input class="form-input" v-model="orderInfo.email"></el-input>
          </el-form-item>
          <el-form-item label="酒店名称：" prop="hotelName">
              <el-input class="form-input" v-model="orderInfo.hotelName"></el-input>
          </el-form-item>
          <el-form-item label="营业执照号码：" prop="hotelCardId">
              <el-input class="form-input" v-model="orderInfo.hotelCardId"></el-input>
          </el-form-item>
      </el-form>

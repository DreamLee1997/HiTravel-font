 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-24 10:22:11
 -->
<template>
  <div class="hotelDetial">
    ...
    <el-dialog
      ...
      <el-form 
          ...
          size="small" 
          label-width="120px">
          <el-form-item label="预定时间：" prop="phone">
            <el-date-picker
          ...
          <el-form-item label="房间单价：" prop="phone">
            <span >{{orderInfo.sellPrice}}¥</span>
            <span style="">{{orderInfo.normalPrice}}¥</span>
              <!-- <el-input class="form-input" v-model="orderInfo.sellPrice"></el-input> -->
          </el-form-item>

 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-30 15:22:49
 -->
<template>
  <div class="hotelDetial">
    <div class="main" v-loading="hotelLoading&&listLoading">
      <div class="main-in">
        ...
        <div class="main-in-bottom">
          ...
          <div class="table-container">
            <el-table ref="roomTable" :data="roomList" style="width: 100%" >
...
export default {
  ...
  methods: {
    ...
    handleSearch() {
      ...
      queryRoomByTime(self.hotelId, self.inDate, self.queryInfo.page, self.queryInfo.size).then(res => {

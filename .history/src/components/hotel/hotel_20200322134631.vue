                ...
                <div class="hotelRmd">
                    <div v-if="isShow">
                        ...
                        <el-row class="content">
                            <el-col 
                                style="width: 235px; height:235px; margin-right: 15px;padding-bottom: 15px;" 
                                v-for="(hotelInfo, index) in hotelList" :key="index" >
                                <el-card :body-style="{ padding: '0px' }" @click.native="toDetail">
                                    <img style="width: 230px; height:230px;" :src="'http://101.132.138.185:8080'+hotelInfo.img" class="image">
                                </el-card>
...
export default {
  data () {
    ...
    methods:{
        ...
        toDetail(){
            let self = this;
            this.$router.push({ path: "/hotelDetial" });
        },
        //点击切换tab

    ...
    <div class="main">
        <div class="main-in">
            ...
            <div class="main-in-bottom">
                <div class="scenicRmd">
                    <div v-for="(hotelInfo, index) in hotelList" :key="index">
                        <!-- <div class="bigTitle">{{hotelInfo.cityName}}</div> -->
                        <div class="title">热门酒店推荐</div>
                        <el-row class="content">
                            <el-col style="width: 235px; margin-right: 15px;padding-bottom: 15px;"  >
                                <el-card :body-style="{ padding: '0px' }">
                                    <img :src="'http://101.132.138.185:8080'+hotelInfo.img" class="image">
                                </el-card>

 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-22 16:42:11
 -->
<template>
            ...
            <div class="main-in-bottom" >
                <div class="table-container">
                  <el-table ref="roomTable" :data="roomList" style="width: 100%" v-loading="listLoading" >
                    ...
                    <el-table-column label="房间类型" prop="roomName" width="120" align="center">
                    </el-table-column>
                    <el-table-column label="房间数量" prop="roomNumber" width="120" align="center"></el-table-column>

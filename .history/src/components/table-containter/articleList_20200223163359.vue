 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-02-23 16:33:59
 -->
 <template>
                    ...
                    <div style="height: 195px;">
                        ...
                        <div class="table-bottom">
                            ...
                            <span class="bottom-span" >
                                ...
                                <span style="margin-right:8px">{{scope.row.collection}}</span>
                            </span>
                            <span class="bottom-span" >
                                <svg-icon class="svg-icon" icon-class="view" />
                                <span style="margin-right:8px">{{scope.row.view}}</span>
                            </span>
                            <!-- <span class="bottom-span" style="margin-right:8px">
                                <svg-icon class="svg-icon" icon-class="view" />

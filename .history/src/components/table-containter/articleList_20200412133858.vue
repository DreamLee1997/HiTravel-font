 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-04-12 13:38:58
 -->
 <template>
                    ...
                    <div style="height: 195px;">
                        ...
                        <div class="table-bottom" >
                            ...
                            <span style="float: right" >
                                <el-button @click.stop="handleOrder(scope.row)" type="primary" size="mini">一键预定</el-button>
                            </span>
                        </div>
                    </div>
                </template>
...
export default {
    ...
    methods: {
        ...
        handleOrder(row){
            let self = this;
            this.$confirm(`是否确认一键预定此攻略i 觉得少了大家快点结束的就开始觉得看书看到快递速度快上课打瞌睡结束了近代史老师讲的是会计师 '${row.title}'`, '提示', {

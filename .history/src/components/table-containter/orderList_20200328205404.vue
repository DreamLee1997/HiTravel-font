 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-28 20:54:04
 -->
<template>
    <div class="orderList" >
        <el-table
            ...
            <el-table-column label="预定时间" prop="bookTime"></el-table-column>
            <el-table-column label="订单状态" prop="status" :show-overflow-tooltip='istooltip'>
                <template slot-scope="scope">{{scope.row | formatScenicStatus}}</template>
            </el-table-column>
            <el-table-column label="用户ID" prop="userId"></el-table-column>
            <el-table-column label="商家名称" prop="hotelOrScenicName"></el-table-column>
            <el-table-column label="商品名称" prop="roomOrTicketName"></el-table-column>
...
import { searchMyOrder, handleCancel } from "@/api/order";
export default {
    props:{
        tabType:{
            type:Array,

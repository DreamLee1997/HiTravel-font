 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-29 17:26:13
 -->
<template>
    <div class="app-container">
        <el-card class="operate-container" >
            ...
            <span style="margin-top: 5px; font-size:18px">酒店-订单列表</span>
                ...
                <el-select v-if="!isShowHotel" size="small" v-model="listQuery.status" placeholder="请选择" class="select">
                    <el-option
        ...
        <el-card class="content-container" v-loading="isloading">
            <el-row v-if="isShowHotel" >
                <el-col 
                    ...
                    :key="item.hotelId" 
                    @click.native="toOrder(item.hotelId, item.hotelName)">
...
export default {
    ...
    methods: {
       ...
       //获取我的酒店列表
        ...
        handleSearch(){
            let self = this;
            self.toOrder(self.hotelId, self.hotelName);
        },

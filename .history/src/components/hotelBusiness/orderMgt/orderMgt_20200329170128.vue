 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-29 17:01:28
 -->
<template>
        ...
        <el-card class="content-container" v-loading="isloading">
            ...
            <div class="table-container" v-if="!isShowHotel">
                ...
                <el-table       
                    ...
                    <el-table-column label="创建时间" prop="createTime" align="center" width="200" :show-overflow-tooltip='istooltip'></el-table-column>
                    <el-table-column label="预定时间" prop="bookTime" align="center" width="100" :show-overflow-tooltip='istooltip'></el-table-column>

<template>
    <div class="app-container">
        ...
        <el-card class="register-container">
            ...
            <div >
                <!-- <img src="../../../assets/img/waitVerify.png" alt=""> -->
                <svg-icon icon-class="waitVerify" style="width: 256px; height: 256px;"></svg-icon>
            </div>
        </el-card>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        handleAddHotel(){
            ...
            self.regHotelInfo.provinceCode = pathvalue.path[0];
            self.regHotelInfo.provinceName = pathvalue.pathLabels[0];
            self.regHotelInfo.cityCode = pathvalue.path[1];
            self.regHotelInfo.cityName = pathvalue.pathLabels[1];
            self.regHotelInfo.areaCode = pathvalue.path[2];
            self.regHotelInfo.areaName = pathvalue.pathLabels[2];
            self.regHotelInfo.streetCode = pathvalue.path[3];
            self.regHotelInfo.streetName = pathvalue.pathLabels[3];
            self.regHotelInfo.img = self.imageUrl;

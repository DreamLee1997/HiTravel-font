 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-09 10:32:27
 -->
<template>
    <div class="app-container">
        ...
        <el-card class="content-container">
            <el-row>
                <el-col class="hotel-card" v-for="(item, index) in list" :key="item.hotelId" :offset="index > 0 ? 2 : 0">
                    <el-card :body-style="{ padding: '0px' }">
                    <img style="height: 100px; width:100px" :src="'http://101.132.138.185:8080'+item.img"  class="image">

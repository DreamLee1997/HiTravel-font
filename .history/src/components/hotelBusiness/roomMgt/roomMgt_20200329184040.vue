 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-29 18:40:40
 -->
<template>
        ...
        handleUpdateConfirm(){
            ...
            this.$confirm('是否确认修改', '提示', {
                ...
                if(self.title == "添加"){
                    ...
                    self.updateRoom.normalPrice = parseInt(self.updateRoom.normalPrice)
                    self.updateRoom.sellPrice = parseInt(self.updateRoom.sellPrice)
                    // if(self.updateRoom.)

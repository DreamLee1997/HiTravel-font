 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-29 18:36:39
 -->
<template>
        ...
        <el-card class="content-container" v-loading="isloading">
            ...
            <div class="table-container" v-if="!isShowHotel">
                ...
                <el-table       
                    ...
                    :data="roomList"
                    style="width: 100%">
                    <el-table-column label="酒店编号" align="center" prop="hotelId" >
                    </el-table-column>
                    <el-table-column label="房间编号" prop="roomId"  align="center">
                    </el-table-column>
                        <el-table-column label="房间名称" prop="roomName" :show-overflow-tooltip='istooltip'  align="center">
                    </el-table-column>
                    ...
                    <el-table-column label="房间状态" :show-overflow-tooltip='istooltip' align="center">
                        <template slot-scope="scope">{{scope.row | formatRoomStatus}}</template>
                    </el-table-column>
        ...
        <el-dialog
            ...
            <el-form 
                ...
                <el-form-item label="房间原价：" prop="normalPrice">
                    <el-input class="form-input" type="number" v-model="updateRoom.normalPrice" :disabled="isEdit"></el-input>
                </el-form-item>
                <el-form-item label="房间现价：" prop="sellPrice">
                    <el-input class="form-input" type="number" v-model="updateRoom.sellPrice" :disabled="isEdit"></el-input>
                </el-form-item>
                <el-form-item label="房间数量：" type="number" prop="roomNumber">
        ...
        handleUpdateConfirm(){
            ...
            this.$confirm('是否确认修改', '提示', {
                ...
                if(self.title == "添加"){
                    ...
                    console.log(self.updateRoom)
                    // self.updateRoom.roomNumber = parseInt(self.updateRoom.roomNumber)
                    // if(self.updateRoom.)

 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-09 20:46:47
 -->
<template>
        ...
        <el-dialog
            ...
            <el-form 
                ...
                <el-form-item label="房间状态" prop="status">
                    ...
                    <el-input class="form-input" v-model="updateRoom.status" :disabled="isEdit"></el-input>
                </el-form-item>
            </el-form>
...
import { queryMyHotel, updateHotel, queryRoom, addRoom, updateRoom} from '@/api/hotelBusiness'

 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-09 20:31:38
 -->
<template>
    <div class="app-container">
        ...
        <el-dialog
            ...
            <el-form 
                ...
                <el-form-item label="房间原价" prop="roomNumber">
                    <el-input class="form-input" v-model="updateRoom.roomNumber" :disabled="isEdit"></el-input>
                </el-form-item>
                <el-form-item label="房间现价" prop="normalPrice">
                    <el-input class="form-input" v-model="editHotel.normalPrice" :disabled="isEdit"></el-input>
                </el-form-item>
                <el-form-item label="房间数量" prop="roomNumber">
                    <el-input class="form-input" v-model="editHotel.roomNumber" :disabled="isEdit"></el-input>
                </el-form-item>
                <el-form-item label="房间状态" prop="status">
                    <el-input class="form-input" v-model="editHotel.status" :disabled="isEdit"></el-input>
                </el-form-item>
            </el-form>
...
import { queryMyHotel, updateHotel, queryRoom, addRoom} from '@/api/hotelBusiness'

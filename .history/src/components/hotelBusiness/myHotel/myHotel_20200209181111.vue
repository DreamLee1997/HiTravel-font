 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-09 18:11:11
 -->
<template>
    <div class="app-container">
        ...
        <el-form 
            ...
            <el-form-item label="所属街道：" prop="areaCode">
                <v-distpicker :province="editHotel.provinceName+'省'" :city="editHotel.cityName+'市'" :area="editHotel.areaName+'区'"></v-distpicker>
                <!-- <el-select v-model="areaCode[0]" placeholder="请选择">
                    <el-option
            ...
            <el-form-item label="酒店图片：" prop="img">
                    <el-upload
                        ...
                        <img v-if="editHotel.img" :src="'http://101.132.138.185:8080'+editHotel.img" class="avatar">
...
export default {
    data () {
        ...
        return {
            ...
            //         const { level } = node;
            //         self.getLevelList(node, resolve);
            //         if(level === 0){
    ...
    //             }
    //     }
    //     this.areaCode = [110000, 110100, 110105];

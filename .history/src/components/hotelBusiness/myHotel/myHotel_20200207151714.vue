    ...
    <div class="app-container">
        ...
        <el-form :inline="true" :model="editHotel" size="small" label-width="120px">
            ...
            <el-form-item label="法人电话：" prop="phone">
                <el-input v-model="editHotel.phone"></el-input>
            </el-form-item>
            <el-form-item label="身份证号：" prop="cardId">
                <el-input v-model="editHotel.cardId"></el-input>
            </el-form-item>
            <el-form-item label="法人邮箱：" prop="email">
                <el-input v-model="editHotel.email"></el-input>
            </el-form-item>
            <el-form-item label="酒店名称：" prop="hotelName">
                <el-input v-model="editHotel.hotelName"></el-input>
            </el-form-item>
            <el-form-item label="营业执照号码：" prop="hotelCardId">
                <el-input v-model="editHotel.hotelCardId"></el-input>
            </el-form-item>

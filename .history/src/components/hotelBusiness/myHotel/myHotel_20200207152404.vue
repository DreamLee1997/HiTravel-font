 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-07 15:23:55
 -->
<template>
    <div class="app-container">
        ...
        width="40%">
        <el-form :inline="true" :model="editHotel" size="small" label-width="120px">
            <el-form-item label="法人姓名：" prop="realname" :disabled.sync="isEdit">
                <el-input class="form-input" v-model="editHotel.realname"></el-input>
            </el-form-item>
            <el-form-item label="法人电话：" prop="phone">
                <el-input class="form-input" v-model="editHotel.phone"></el-input>
            </el-form-item>
            <el-form-item label="身份证号：" prop="cardId">
                <el-input class="form-input" v-model="editHotel.cardId"></el-input>
            </el-form-item>
            <el-form-item label="法人邮箱：" prop="email">
                <el-input class="form-input" v-model="editHotel.email"></el-input>
            </el-form-item>
            <el-form-item label="酒店名称：" prop="hotelName">
                <el-input class="form-input" v-model="editHotel.hotelName"></el-input>
            </el-form-item>
            <el-form-item label="营业执照号码：" prop="hotelCardId">
                <el-input class="form-input" v-model="editHotel.hotelCardId"></el-input>
            </el-form-item>
        ...
        <span slot="footer" class="dialog-footer" >
            ...
            <el-button v-show="isEdit"  type="primary" @click="handleEditConfirm" size="mini">确 定</el-button>
        </span>
        </el-dialog>
    </div>
</template>

 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-09 10:24:09
 -->
<template>
            ...
            <div class="table-container">
                <el-table ref="productTable"
                    ...
                    <template slot-scope="scope">
                        <img style="height: 80px; width:80px" :src="'http://101.132.138.185:8080'+scope.row.img"></template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        handleEditConfirm(){
            let self = this;
            // self.editHotel.img = '/img/318c2e83-97b5-4386-9891-214d21f6fa83.jpg'

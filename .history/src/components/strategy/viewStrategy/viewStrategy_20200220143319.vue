 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-20 14:33:19
 -->
<template>
    ...
    <div style="margin: 20px 160px 0 160px;">
      ...
      <div class="bottom">
        <span class="bottom-span">
          <svg-icon class="svg-icon" icon-class="praise" @click="handlePraise" />
          {{strategyInfo.praise}}
        </span>
        <span class="bottom-span">
          <svg-icon class="svg-icon" icon-class="collection" @click="handleCollect" />
          {{strategyInfo.collection}}
        </span>
        <span class="bottom-span">
          <svg-icon class="svg-icon" icon-class="view" @click="handleView" />
          {{strategyInfo.view}}
        </span>
      </div>
      <div class="comment">

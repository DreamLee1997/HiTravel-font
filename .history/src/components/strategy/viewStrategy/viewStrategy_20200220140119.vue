 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-20 14:01:18
 -->
<template>
    <div class="srategy-container">
        <div style="margin: 20px 160px 0 160px;">
            ...
            <div>
                <span><svg-icon icon-class="praise" />{{strategyInfo.praise}}</span>
                <span><svg-icon icon-class="collection" />{{strategyInfo.collection}}</span>
                <span><svg-icon icon-class="view" />{{strategyInfo.view}}</span>
            </div>
        </div>
    </div>
</template>

 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-21 16:50:43
 -->
<template>
  <div class="srategy-container">
    <el-card style="margin: 20px 160px 0 160px;" id="card-container">
      ...
      <div style="margin-top: 55px;">
        ...
        <el-input  v-else style="width:400px" v-model="ruleForm.cityName" disabled=""></el-input>
...
import { addStrategy, queryArticleById } from "@/api/strategy";

 ...
 * @LastEditors  : lixiang
 * @LastEditTime : 2020-02-16 12:02:38
 -->
<template>
...
export default {
    ...
    data(){
        return {
            ruleForm:{
                words:'<p>sddsdadsa</p><p><br></p><p>dssdaa</p><p><br></p><p><br></p><p><br></p><p><img src="http://101.132.138.185:8080//img/adb07f25-f57b-4c2c-8111-e26819b80272.jpeg"></p><p><br></p><h3>Sddas的</h3>'
            },
            editorOption: {
                placeholder: "请输入",

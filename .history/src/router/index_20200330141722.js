 ...
 * @LastEditors: lixiang
 * @LastEditTime: 2020-03-30 14:17:22
 */
import Vue from 'vue'
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'orderMgt',
          name: 'orderMgt',
          component: () => import('@/components/hotelBusiness/orderMgt/orderMgt'),
          meta: {
            keepAlive: true   //true,页面不带navbar和footer
          },
        }
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'orderMgt',
          name: 'orderMgt',
          component: () => import('@/components/scenicBusiness/orderMgt/orderMgt'),
          meta: {
            keepAlive: true   //true,页面不带navbar和footer
          },
        }
